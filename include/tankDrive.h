...
class tankDrive{
  public:
    ...
    tankDrive(double wheelDiameter, double wheelToWheel):
      wheelCircumfrence(wheelDiameter * M_PI), wheelBaseCircumfrence(wheelToWheel * M_PI)
    {}

    tankDrive(double wheelDiameter, double wheelToWheel, double linScale, double rScale):
      wheelCircumfrence(wheelDiameter * M_PI), wheelBaseCircumfrence(wheelToWheel * M_PI), yScaleJoy(linScale), rScaleJoy(rScale)
    {}

    tankDrive(double wheelDiameter, double wheelToWheel, double xScale, double yScale, double rScale):
